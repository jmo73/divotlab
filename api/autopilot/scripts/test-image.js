...
async function run() {
    ...
    const samples = [
        {
            ...
            fields: (0, imageGen_1.leaderboardFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.playerStatFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.modelPickFields)({
        ...
        },
        {
            name: 'cut-line',
            templateId: 'cut-line',
            fields: (0, imageGen_1.cutLineFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.evergreenFactFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.quoteInsightFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.comparisonFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.courseBreakdownFields)({
        ...
        },
        {
            ...
            fields: (0, imageGen_1.weatherCardFields)({
    ...
    for (const sample of samples) {
        ...
        const buf = await (0, imageGen_1.generateImage)(sample.templateId, sample.fields);
        const outPath = path_1.default.join(OUT_DIR, `${sample.name}.png`);
