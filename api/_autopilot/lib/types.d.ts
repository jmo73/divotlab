export type QueueStatus = 'pending' | 'pending_edit' | 'pending_edit_regenerating' | 'approved' | 'posted' | 'partial' | 'failed' | 'skipped' | 'expired' | 'telegram_failed';
export type TriggerType = 'live_leaderboard_r1_end' | 'live_leaderboard_r2_end' | 'live_leaderboard_r3_end' | 'live_leaderboard_final' | 'mid_round_mover' | 'cut_bubble_alert' | 'weather_angle' | 'pre_tournament_model_picks' | 'post_round_sleeper' | 'comparison_spotlight' | 'evergreen_sg_explainer' | 'evergreen_course_profile' | 'evergreen_player_spotlight' | 'evergreen_stat_of_week' | 'evergreen_myth_bust';
export type TemplateId = 'leaderboard' | 'player-stat' | 'model-pick' | 'cut-line' | 'evergreen-fact' | 'quote-insight' | 'comparison' | 'course-breakdown' | 'weather-card' | 'player-hero';
...
export type TournamentStatus = 'LIVE' | 'PRE_TOURNAMENT' | 'POST_R1' | 'POST_R2' | 'POST_R3' | 'COMPLETED' | 'OFF';
