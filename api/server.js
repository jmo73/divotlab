...
<section class="post-hero">
  <div class="post-hero-content">
    ...
    <h1>${escapeHtml(tournament)} ${escapeHtml(roundText)}: ${titleSuffix}</h1>
    <div class="post-hero-meta">
      ${publishDate} <span class="dot">·</span> 6 min read <span class="dot">·</span> Tournament Analysis
    </div>
  </div>
</section>
...
<div class="read-next-wrap">
  <div class="read-next-inner">
    <div class="read-next-label">Read Next</div>
    <div class="read-next-grid">
      <a href="/strokes-gained-approach" style="text-decoration:none;color:inherit;">
      <div class="rn-card">
        <div class="rn-img">
          <img src="/fleetwood.jpg" alt="Strokes gained approach" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;">
        </div>
        <div class="rn-body">
          <span class="rn-cat sg">Strokes Gained</span>
          <h3 class="rn-title">The Stat No One Talks About: Why SG: Approach Wins More Tournaments Than Driving</h3>
      ...
      <a href="/driver-upgrade-myth" style="text-decoration:none;color:inherit;">
      <div class="rn-card">
        <div class="rn-img">
          <img src="/driver.jpg" alt="Driver upgrade myth" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;">
        </div>
        <div class="rn-body">
          <span class="rn-cat improve">Improvement</span>
          <h3 class="rn-title">The $600 Myth: Is Upgrading Your Driver Actually Worth It?</h3>
...
<footer>
  <div class="footer-grid">
    ...
    <div class="f-col">
      <h5>Read</h5>
      <a href="/scheffler-putting-analysis">PGA Tour Analysis</a>
      <a href="/strokes-gained-approach">Strokes Gained</a>
      <a href="/driver-upgrade-myth">Improvement</a>
    </div>
    <div class="f-col">
      <h5>Shop</h5>
      <a href="https://divotlab.printful.me/">Tees</a>
