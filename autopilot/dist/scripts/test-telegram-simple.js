...
// ── Caption generator ─────────────────────────────────────────────────────────
async function generateCaptions(cardData) {
...
async function main() {
    ...
    const imageBuffer = await (0, renderHtml_1.renderHtmlTemplate)('leaderboard', fields, { width: 1080, height: 1350 });
...
//# sourceMappingURL=test-telegram-simple.js.map