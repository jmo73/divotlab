...
async function testLeaderboard() {
  ...
  const buf = await renderHtmlTemplate('leaderboard', fields, DIM)
...
async function testPlayerSpotlight() {
  ...
  const buf = await renderHtmlTemplate('player-spotlight', fields, DIM)
...
async function testCourseProfile() {
  ...
  const buf = await renderHtmlTemplate('course-profile', fields, DIM)
...
async function testWeatherCard() {
  ...
  const buf = await renderHtmlTemplate('weather-card', fields, DIM)
