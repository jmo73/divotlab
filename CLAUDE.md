...
| 2026-06-18 | U.S. Open Lab Picks Pro published | `lab-notes/lab-picks/2026-06-18-us-open-picks.html` — 5 picks, no H2H (H2H board showed no clean positive EV at accessible US books). No course-fit model for Shinnecock (US Open rotates venues yearly); card built entirely on DataGolf EV vs. market lines. Picks: Hojgaard Top 10 DK +1000 (+4.8% EV, DG fair +949 — also free pick in `current-pick.json`), English Top 20 FD +340 (+5.5% EV — highest edge on board), Mitchell Top 20 Bet365 +500 (+3.7% EV), Lee Min Woo Top 10 DK +630 (+2.3% EV), Fleetwood Top 5 DK +500 (+1.5% EV). Sleeper (not tracked): Kim Si Woo Win BetMGM +4000 (+2.5% EV, DG fair +3900). All picks capped ≤+1000 per standing directive. `pro-picks.json` updated with all 5 picks (result: null). Season tracker going in: 54 picks, 24 hits, 44.4%, +31.15u, 57.7% ROI, 13 events. |
