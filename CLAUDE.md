...
| 2026-07-06 | John Deere Classic results updated | 0 for 5. Rai LOSS (T30), Henley LOSS (T12), Straka LOSS (T72), Fleetwood LOSS (T14), Kitayama LOSS (T25). Lucas Glover won. Two consecutive 0-for-5 weeks — approach weight at putting-premium venues under review. Week net: -5.00u. Season: 69 picks, 24 hits, 34.8%, +16.15u, 23.4% ROI, 16 events. `season-tracker.json` updated; JDC weekly_picks entry appended. |
| 2026-07-06 | Genesis Scottish Open newsletters written | Lab Notes: `lab-notes/issues/2026-07-07-genesis-scottish-open.html` — JDC recap (accountability callout on two consecutive 0-for-5 weeks) + Renaissance Club preview (OTT 28%, App 26%, ARG 24%, Putt 22%). Note: three player cards have `[CF]` placeholders to fill from /api/course-fit before publishing. Lab Picks: `lab-notes/lab-picks/2026-07-08-genesis-scottish-open-picks.html` — 5 picks: Gotterup Top 10 FD +300 (defending champ, negative EV disclosed), Schauffele Top 20 FD +125 (+1.3% EV), Fleetwood Top 10 FD +250 (near-flat), Lowry Top 20 FD +300 (+0.9% EV), Lee Min Woo Top 10 Bet365 +470. Sleeper: Lowry Win. `current-pick.json` and `pro-picks.json` updated (results: null). |
| 2026-07-06 | picks.html "Pick History / Recent results" section removed | Removed the entire results history section — CSS classes, HTML block, and JS fetch block. Page now ends after the current free pick card. User decided the section was no longer needed. |
| 2026-07-06 | /pro mobile UI — 3 bug fixes | All changes confined to `@media(max-width:900px)`, desktop untouched. (1) CF row nth-child mapping: avatar added as child 2 after mobile CSS was written had offset all grid-area assignments by one — fixed by hiding child 2 and remapping children 3–7 to player/fit/bars/odds/dls. (2) Hamburger drawer max-height raised 300px→400px: drawer content (~328px) clipped the Pro button. (3) Live indicator dot in bottom nav: `.psb-live-indicator` CSS only existed in `.psb-nav-item` context — added `.bnav-item .psb-live-indicator` rule so the pulsing dot renders in the mobile bottom nav Live button. |
| 2026-07-13 | Genesis Scottish Open results updated | 1 for 5. Gotterup LOSS (T11), Schauffele LOSS (CUT +3), Fleetwood LOSS (T13), Lowry LOSS (CUT E), Lee Min Woo WIN (T2 -15, +4.70u). Tom Kim won at -17. Week net: +0.70u. Season: 74 picks, 25 hits, 33.8%, +16.85u, 22.8% ROI, 17 events. `season-tracker.json` updated; Scottish weekly_picks entry appended. `pro-picks.json` and `current-pick.json` results marked. |
| 2026-07-13 | The Open Championship newsletters written | Lab Notes: `lab-notes/issues/2026-07-14-genesis-scottish-open-recap-open-preview.html` — Scottish Open recap (Tom Kim +2.16 SG:App/rd, accountability on 1-for-5 card, week net +0.70u), Royal Birkdale preview (Par 70, Southport England, last held 2017 Spieth, no course-fit weights — Open rotates yearly), 3 Players to Watch (Fleetwood local/Southport, Si Woo Kim T9 form, McIlroy model fav), Stat of the Week (+2.16 SG:App Tom Kim). Lab Picks: `lab-notes/lab-picks/2026-07-15-the-open-championship-picks.html` — 5 picks (3 Top 20 / 2 Top 10 structure, shifted card prioritizing higher probability): Fitzpatrick Top 20 FD +300 (+8.4% EV), English Top 20 B365 +390 (+13.7% EV — highest on card), Noren Top 20 B365 +470 (+8.8% EV), Kim Si Woo Top 10 B365 +480 (+4.3% EV — free pick), Rai Top 10 FD +650 (+4.7% EV, Low confidence). No sleeper section. `pro-picks.json` updated with The Open 5 picks. `current-pick.json` updated: Si Woo Kim Top 10 Bet365 +480. |
