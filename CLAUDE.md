...
| 2026-06-25 | Travelers Championship Lab Picks Pro published | `lab-notes/lab-picks/2026-06-25-travelers-championship-picks.html` — 5 picks at TPC River Highlands (Putt 32%, App 28%). Key insight: putting narrative already priced in — Burns (DG Top 10 fair +317) listed at +210-225, making all elite-putter bets negative EV. Value in approach-dominant players. Card: Rai Top 5 DK +1000 (+13.5% EV, App #17, free pick), Spaun Top 10 FD +430 (+8.4% EV, App #2), Straka Top 10 FD +900 (+10.5% EV, App #25), Kim Si Woo Top 5 Bet365/FD +550 (+6.8% EV, App #6), Kitayama Top 5 FD +1000 (+2.7% EV, App #9). Sleeper (not tracked): Rai Win DK +5500 (+6.5% EV — only positive EV bet in win market). `pro-picks.json` and `current-pick.json` updated. Homepage headline updated to "Player breakdowns and course-fit analysis for the PGA Tour" (no period). |
